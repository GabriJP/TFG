...
class TemporalLinkage(snt.RNNCore):
    ...
    @staticmethod
    def _precedence_weights(prev_precedence_weights, write_weights):
...
class Freeness(snt.RNNCore):
    ...
    *   Decreased by reading, where usage is decreased after reading from a
    ...
    @staticmethod
    def _usage_after_write(prev_usage, write_weights):
    ...
    @staticmethod
    def _usage_after_read(prev_usage, free_gate, read_weights):
